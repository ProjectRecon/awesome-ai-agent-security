...
- **[Reapproval Gate](https://github.com/selfradiance/reapproval-gate)** - A deterministic local gate that evaluates a proposed agent action against human-approved scope and returns allow, deny, or reapproval_required on escalation thresholds.
