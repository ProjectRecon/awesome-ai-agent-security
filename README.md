...
- **[Koma](https://github.com/swnotmetal/Project-Koma)** - A zero-dependency Node.js/TypeScript AI security toolkit for prompt-injection defense, request filtering, and protected AI data access.
